---
name: emotional-flashback-13-steps
description: |
  当用户报告情绪闪回发作——突然被不可名状的恐惧/羞耻/渺小感淹没，现实并无危险， 时间感坍缩为"永恒"——时使用。按 Walker 13 步当下化：命名闪回→确认现在安全→主张边界→ 安抚内在小孩→拆解永恒化→回到成人身体→躯体着陆→抑制内在批判者灾难化→允许哀悼→ 寻求安全关系→识别触发源→追溯闪回对象→耐心对待慢恢复。 现实危险/家暴/自伤自杀危机时禁用"我现在安全"暗示，立即转安全计划。
metadata:
  cangjie.generated-by: cangjie-tools v2.5.0
  cangjie.capability-id: cap.complex-ptsd.emotional-flashback-13-steps
  ...
  cangjie.tags: cptsd, emotional-flashback, grounding, crisis, self-regulation
---
# 情绪闪回发作时的13步当下化处置
