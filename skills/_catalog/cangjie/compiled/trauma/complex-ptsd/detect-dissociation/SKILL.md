---
name: detect-dissociation
description: |
  当对话中对方突然"断电"——眼神放空、回应延迟、情感扁平、声音变远、说"我不知道我在哪"—— 时使用。识别解离 (depersonalization/derealization)，用低强度感官锚定回收注意， 不追问"你为什么不说话/你不在乎吗"。解离严重或伴遗忘时转专业评估。
metadata:
  cangjie.generated-by: cangjie-tools v2.5.0
  cangjie.capability-id: cap.complex-ptsd.detect-dissociation
  ...
  cangjie.tags: dissociation, depersonalization, awareness, grounding
---
# 解离识别与回收
